...
public class QRCodeFactory {
     ...
     */
    public void CreatQrImage(String content, String format, String outFileUri, String logUri, int... size) throws IOException, WriterException, WriterException {
        // 二维码图片宽度 430
        int width = 430;
        // 二维码图片高度430
        int height = 430;
