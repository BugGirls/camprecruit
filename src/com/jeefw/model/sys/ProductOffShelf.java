...
import com.jeefw.model.sys.param.ProductOffShelfParameter;
 ...
 */
@Entity
@Table(name = "product_off_shelf")
@Cache(region = "all", usage = CacheConcurrencyStrategy.READ_WRITE)
@JsonIgnoreProperties(value = { "maxResults", "firstResult", "topCount", "sortColumns", "cmd", "queryDynamicConditions", "sortedConditions", "dynamicProperties", "success", "message", "sortColumnsString", "flag" })
public class ProductOffShelf extends ProductOffShelfParameter {
	...
	@Column(name = "offShelf_no", length = 50)
	private String offShelfNo;//所属下架单号
	
	@Column(name = "onShelf_id", length = 50)
	private String onShelfId;//所属上架ID
	...
	public String getOffShelfNo() {
		return offShelfNo;
	}

	public void setOffShelfNo(String offShelfNo) {
		this.offShelfNo = offShelfNo;
	}
	...
	public void setOnShelfId(String onShelfId) {
		this.onShelfId = onShelfId;
	}

	public ProductOffShelf(Long id, String intoWarehouseRecordNo, String productWarehouseId, String onShelfNo,
			String offShelfNo, String onShelfId, String productNo, String productName, String productBarCode, Long num,
			Float salePrice, Float intoPrice, Float advicePrice, String bigCategoryNo, String bigCategoryName,
			String smallCategoryNo, String smallCategoryName, String productPropertyTempNo, String image, String image1,
			String image2, String image3, String content, String brand, String shelfLocation, Date productionDate,
			String allianceId, Date groundDate, String creater, String createrNo, ProductInfo productInfo) {
		super();
		this.id = id;
		this.intoWarehouseRecordNo = intoWarehouseRecordNo;
		this.productWarehouseId = productWarehouseId;
