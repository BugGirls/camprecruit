 ...
 */
@Controller
@RequestMapping("/sys/userxieyi")
public class UserxieyiController extends JavaEEFrameworkBaseController<TzzJianjie> implements Constant {
