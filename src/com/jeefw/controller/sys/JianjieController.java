 ...
 */
@Controller
@RequestMapping("/sys/tzzjianjie")
public class JianjieController extends JavaEEFrameworkBaseController<TzzJianjie> implements Constant {
