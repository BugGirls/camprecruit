 ...
 */
@Controller
@RequestMapping("/sys/zhihuiyingdi")
public class ZhihuiyingdiController extends JavaEEFrameworkBaseController<TzzJianjie> implements Constant {

	@Resource
	private TzzJianjieService tzzJianjieService;

	// 查询信息发布的表格，包括分页、搜索和排序
	// sys/zhihuiyingdi/getjianjie
