 		...
 		<div style="display: none;position:absolute ;z-index:999;top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="aid" >
		  <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="aclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form2" method="post" enctype="multipart/form-data" action="${contextPath}/sys/TzzSafetyNews/fileUpload">  
			<input type="hidden" id="addContent" name="addContent"/>
			<div style="float:left;"> 
				<div style="float:left;"> 		
		  		新闻标题	&nbsp;<input type="text" name="name" id="aname" maxlength="60"/><br><br>
				导语		&nbsp;<input type="text" name="brief" id="abrief" maxlength="255"/><br><br>
				
				新闻类型	&nbsp;<select id="atypeId" name="type"> </select><br><br>
				新闻来源	&nbsp;<select id="aoriginId" name="origin"> </select><br><br>
				...
				是否置顶	&nbsp;<input type="checkbox" name="istop" id="aistop" /><br><br>
		...
		<div style="display: none;position:absolute ; z-index:999; top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="hid" >
		   <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="fclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form1" method="post" enctype="multipart/form-data" action="${contextPath}/sys/TzzSafetyNews/fileUpload">			
				<input type="hidden" name="id" id="fid"/><br><br>
				<input type="hidden" id="editContent" name="addContent"/>
				<div style="float:left">
				<div style="float:left;"> 	
				新闻标题	&nbsp;<input type="text" name="name" id="fname" maxlength="60"/><br><br>
				导语	&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="brief" id="fbrief" maxlength="255"/><br><br>
				新闻类型	&nbsp;<select id="ftypeId" name="type"> </select><br><br>
				新闻来源	&nbsp;<select id="foriginId" name="origin"> </select><br><br>
				<input type="hidden" name="image" id="image">
				<span  id="fimage"> 
				</span> 
				</div>
				<div style="float:left; padding-left: 100px;"> 	
				是否置顶	&nbsp;<input type="checkbox" name="istop" id="fistop" /><br><br>
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/TzzSafetyNews/getSafetyNewsList",
        			datatype : "json",
        			height : 650,
        			colNames : ['', 'ID', '新闻标题', '导语', '新闻类型','新闻类型','新闻来源','新闻来源','图片路径','新闻内容', '是否置顶','是否置顶', '是否发布','是否发布','创建人','创建时间','发布时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 60,
        			...
        			editurl : "${contextPath}/sys/TzzSafetyNews/operateSafetyNews"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
			...
			$('[data-rel=popover]').popover({html:true});
				...
				$.ajax({//classifycn
			        ...
			        data:{"parentId":"143"},
			   		dataType:"html", 
			       	success:function(data){   
			       		$("#foriginId").append(data); 
			       		$("#aoriginId").append(data);    
			       	} 
			    });
