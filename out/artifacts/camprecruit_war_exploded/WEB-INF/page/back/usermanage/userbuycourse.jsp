...
<div class="row">
	<div class="col-xs-12">
		...
		<script type="text/javascript">
			...
			function showbuydetail(userId){
				location.href = "${contextPath}/sys/sysuser/home#page/userbuycoursedetail?userId="+ userId;
			}
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/userBuyCourse/getUserBuyCourse",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID' ,'昵称','购买课程数量','消费金额','交易次数','操作'],
        			...
        			//	searchoptions : {sopt : ['eq']},
        				...
        				formatter: function (value, grid, rows, state) 
       					{
       					 return "<a  onclick=\"javascript:showbuydetail(" + value + ");\"  style='cursor:pointer;'> 查看详细 </a>" ;
       					} ,
        				sorttype : "int",
        				search : false
        			} ],
        		...
        		function parsefloat(cellvalue, options, rowdata){
        	  		var s = cellvalue + "";
