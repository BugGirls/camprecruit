        ...
        $(".page-content-area").ace_ajax("loadScripts", scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/vipquanyi/getjianjie",
        			datatype : "json",
        			height : 400,
        			colNames : ["ID"  ,"标题","创建时间",""],
        			colModel : [ {
        			...
        			editurl : "${contextPath}/sys/message/operatejianjie"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		$("#submitButton").on("click", function(e) {  
        			...
        			if (content == "") {
    					...
    					return false; 
    			    	 ...
    			    	 $.ajax({
            			 	dataType : "json",
            			 	url : "${contextPath}/sys/vipquanyi/operatejianjie?oper=save",
            			 	type : "post",
            			 	data : {
            			 		id : $("#id").val(), 
            			 		content :content  
				...
				jQuery(grid_selector).jqGrid("navButtonAdd", pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/vipquanyi/operatejianjie?oper=excel' method='post'>";
