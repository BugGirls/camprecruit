        ...
        $(".page-content-area").ace_ajax("loadScripts", scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/tzzjianjie/getjianjie",
        			datatype : "json",
        			height : 450,
        			colNames : ["ID",  "图片","发布时间",   "正文"],
        			colModel : [ {
        				name : "id",
        				index : "id",
        				label : "ID",
        			...
        			editurl : "${contextPath}/sys/tzzjianjie/operatejianjie"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        			...
        			if ($("#title").val() == "") {
    				   ...
    				   return false; 
    			    	...
    			    	con = con.substring(0,con.indexOf("/\>")+2 );    
    			    	 $.ajax({
            			 	dataType : "json",
            			 	url : "${contextPath}/sys/tzzjianjie/operatejianjie?oper=save",
            			 	type : "post",
            			 	data : {
            			 		id : $("#id").val(), 
            			 		content :content ,
				...
				jQuery(grid_selector).jqGrid("navButtonAdd", pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/tzzjianjie/operatejianjie?oper=excel' method='post'>";
