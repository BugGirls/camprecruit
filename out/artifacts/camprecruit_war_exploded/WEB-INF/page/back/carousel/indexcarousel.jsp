	...
	$('.page-content-area').ace_ajax('loadScripts',scripts,function() {
					...
					jQuery(function($) { 
							...
							jQuery(grid_selector).jqGrid({
												subGrid : false,
												url : "${contextPath}/sys/carousel/getTzzIndexCarousel?style=0",
												datatype : "json",
												height : 650,
												...
												editurl : "${contextPath}/sys/carousel/operateTzzIndexCarousel?style=0"
											//caption : "用户管理列表",
											//autowidth : true,
											/**
											grouping : true, 
				...
				//============================================================================			
							...
							$("#editaaa").click(function(){
								...
								var carouselType=rowData.carouselTypecn;
								...
								$("#fcarouselType").val(carouselType);
								 if(state=="显示"){
									 state=1;
								 }else{
									 state=0;
