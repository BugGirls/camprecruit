...
<div class="row">
	<div class="col-xs-12">
		...
		<!-- PAGE CONTENT ENDS > -->
		 ...
		 <div style="display: none;position:absolute ;top:20%;left:30%;background-color: #fff;border: 1px solid #aaa;" id="aid" >
		  ...
		  <div style="padding: 10px;">
		  	<form id="form2" method="post" enctype="multipart/form-data" action="${contextPath}/sys/carousel/fileUpload"> 
		...
		<div style="display: none;position:absolute ;top:20%;left:30%;background-color: #fff;border: 1px solid #aaa;" id="hid" >
		  ...
		  <div style="padding: 10px;">
		  	<form id="form1" method="post" enctype="multipart/form-data" action="${contextPath}/sys/carousel/fileUpload">			
					...
					jQuery(function($) { 
					 	...
					 	$('[data-rel=popover]').popover({html:true});
							...
							jQuery(grid_selector).jqGrid({
												subGrid : false,
												url : "${contextPath}/sys/carousel/getTzzIndexCarousel?style=2",
												datatype : "json",
												height : 650,
												...
												editurl : "${contextPath}/sys/carousel/operateTzzIndexCarousel?style=2"
											//caption : "用户管理列表",
											//autowidth : true,
											/**
											grouping : true, 
							...
							$.ajax({
						        type:"post",
						        url:"${contextPath}/sys/Tzzdic/getvipSelectforIndexListedit",
						        data:{},
						   		dataType:"json", 
						       	success:function(data){  
						       		$("#fcarouselType").html(data.d); 
						       		$("#acarouselType").html(data.d);    
						       	} 
						    });
