 		...
 		<div style="display: none;position:absolute ;z-index:999;top:0;left:0;background-color: #fff;border: 1px solid #aaa;width: 600px;"" id="aid" >
		  <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="aclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form2" method="post" enctype="multipart/form-data" action="${contextPath}/sys/groupbuy/saveOrUpdateGroupBuy">  
			<input type="hidden" name="combopriceid" value="${combopriceid }"/>
			<div style="float:left;"> 
		  		团购数量	&nbsp;<input type="text" name="ordernum" id="aordernum" /><br><br>
				团购价格	&nbsp;&nbsp;&nbsp;<input type="text" name="price" id="aprice" maxlength="10"/><br><br>
			 	是否可用	&nbsp;<input type="checkbox" name="status" id="astatus" /><br><br>
		...
		<div style="display: none;position:absolute ; z-index:999; top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="hid" >
		   <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="fclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form1" method="post" enctype="multipart/form-data" action="${contextPath}/sys/groupbuy/saveOrUpdateGroupBuy">			
				<input type="hidden" name="id" id="fid"/><br><br>
				<input type="hidden" name="combopriceid" value="${combopriceid }"/>
				<div style="float:left">
				团购数量	&nbsp;<input type="text" name="ordernum" id="fordernum" /><br><br>
				团购价格	&nbsp;&nbsp;&nbsp;<input type="text" name="price" id="fprice" maxlength="10"/><br><br>
			 	是否可用	&nbsp;<input type="checkbox" name="status" id="fstatus" /><br><br>
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/groupbuy/getGroupBuyList?combopriceid=${combopriceid}",
        			datatype : "json",
        			height : 650,
        			colNames : ['', 'ID', '团购人数','团购价格','是否可用','创建时间','修改时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 200,
        			...
        			editurl : "${contextPath}/sys/groupbuy/operateGroupBuy"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
...
//===========================================================================================	
				...
				$("input[name='up']").click(function(){  
					if($("#fordernum").val()==null||$("#fordernum").val()==""){
						alert("请填写团购人数");
						return;
					}
    			    ...
    			    if($("#fordernum").val()!=""&&$("#fordernum").val()!="0"&&!regz.test($("#fordernum").val())){  
    			        alert("团购人数必须是整数格式!");  
    			        return ;
    			    }
					 $("#form1").submit();
				...
				$("input[name='aup']").click(function(){  
					...
					if($("#aordernum").val()==null||$("#aordernum").val()==""){
						alert("请填写团购人数");
						return;
					}
					var regz = new RegExp("^[0-9]*[1-9][0-9]*$");
    			    ...
    			    if($("#aordernum").val()!=""&&$("#aordernum").val()!="0"&&!regz.test($("#aordernum").val())){  
    			        alert("团购人数必须是整数格式!");  
    			        return ;
    			    }
					 $("#form2").submit();
