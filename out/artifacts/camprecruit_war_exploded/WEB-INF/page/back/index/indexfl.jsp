        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/indexfl/getindexfl",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '类别','创建时间',''],
        			colModel : [ {
        			...
        			editurl : "${contextPath}/sys/indexfl/operateindexfl"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/indexfl/operateindexfl?oper=excel' method='post'>";
