 		...
 		<div style="display: none;position:absolute ;z-index:999;top:0;left:0;background-color: #fff;border: 1px solid #aaa;width: 600px;"" id="aid" >
		  <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="aclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form2" method="post" enctype="multipart/form-data"  action="${contextPath}/sys/coachlevel/saveOrUpdateCoachLevel">  
			<input type="hidden" id="addContent" name="addContent"/>
			<div style="float:left;"> 
		  		级别名称	&nbsp;<input type="text" name="levelname" id="alevelname" /><br><br>
		  		级别描述	&nbsp;<textarea rows="10" cols="64" name="leveldesc" id="aleveldesc" ></textarea><br><br>
		  		晋升级别分数	&nbsp;<input  type="text"  name="levelgrade" id="alevelgrade" /><br><br>
		  		晋升级别评论人数	&nbsp;<input  type="text"  name="commentnum" id="acommentnum" /><br><br>
		...
		<div style="display: none;position:absolute ; z-index:999; top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="hid" >
		   <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="fclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form1" method="post"  enctype="multipart/form-data"  action="${contextPath}/sys/coachlevel/saveOrUpdateCoachLevel">			
				<input type="hidden" name="id" id="fid"/><br><br>
				<div style="float:left">
						级别名称	&nbsp;<input type="text" name="levelname" id="flevelname" /><br><br>
				  		级别描述	&nbsp;<textarea rows="10" cols="64" name="leveldesc" id="fleveldesc" ></textarea><br><br>
				  		晋升级别分数	&nbsp;<input  type="text"  name="levelgrade" id="flevelgrade" /><br><br>
				  		晋升级别评论人数	&nbsp;<input  type="text"  name="commentnum" id="fcommentnum" /><br><br>
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/coachlevel/getCoachLevel",
        			datatype : "json",
        			height : 650,
        			colNames : ['','ID', '教练级别名称','级别描述', '晋升所需分数', '晋升评论人数'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 60,
        			...
        			editurl : "${contextPath}/sys/coachlevel/operateCoachLevel"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        ...
        //=====================================================
			...
			$('[data-rel=popover]').popover({html:true});
				...
				$("#editaaa").click(function(){
					...
					var id=rowData.id;
					var levelname=rowData.levelname;
					var leveldesc=rowData.leveldesc;
					var levelgrade=rowData.levelgrade;
					var commentnum=rowData.commentnum;
					
					$("#fid").val(id);
					$("#flevelname").val(levelname);
					$("#fleveldesc").val(leveldesc);
					$("#flevelgrade").val(levelgrade);
					$("#fcommentnum").val(commentnum);
