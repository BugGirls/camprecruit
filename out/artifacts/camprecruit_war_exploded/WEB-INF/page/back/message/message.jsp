				...
				<div class="modal-body" style="max-height: 500px;overflow-y: scroll;">
					...
					<div class="blue clearfix">
						<label for="author">分类：</label>
						 <select id="type" > 
						 	<option value="1">网站服务</option>
						  	<option value="2">帮助中心</option>
						   	<option value="3">交流合作</option>
						 </select>
					</div>  
        ...
        $(".page-content-area").ace_ajax("loadScripts", scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/message/getmsg",
        			datatype : "json",
        			height : 400,
        			colNames : ["ID", "标题","分类", "发布时间", "",'' ],
        			colModel : [ {
        				name : "id",
        				index : "id",
        				label : "ID",
        			...
        			editurl : "${contextPath}/sys/message/operatemsg"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		$("#submitButton").on("click", function(e) {  
        			...
        			if ($("#title").val() == "") {
    					...
    					$("#modal-tip").html("请填写内容");
    			    	 ...
    			    	 $.ajax({
            			 	dataType : "json",
            			 	url : "${contextPath}/sys/message/operatemsg?oper=save",
            			 	type : "post",
            			 	data : {
            			 		id : $("#id").val(),
            			 		title : $("#title").val(),  
				...
				jQuery(grid_selector).jqGrid("navButtonAdd", pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/message/operatemsg?oper=excel' method='post'>";
