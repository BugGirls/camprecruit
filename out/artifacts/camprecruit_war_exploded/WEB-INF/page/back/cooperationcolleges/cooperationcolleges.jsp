 		...
 		<div style="display: none;position:absolute ;z-index:999;top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="aid" >
		  <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="aclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form2" method="post" enctype="multipart/form-data" action="${contextPath}/sys/cooperationcolleges/fileUpload">  
			<input type="hidden" id="addContent" name="addContent"/>
			<div style="float:left;"> 
				<div style="float:left;"> 		
		  		合作院校名称	&nbsp;<input type="text" name="name" id="aname" maxlength="60"/><br><br>
				校训		&nbsp;<input type="text" name="brief" id="abrief" maxlength="255"/><br><br>
				类型	&nbsp;<select id="atypeId" name="type"><option value="1">综合性</option><option value="2">理工</option><option value="3">体育</option> </select><br><br>
				性质	&nbsp;<select id="axingzhi" name="xingzhi"><option value="1">本科</option><option value="2">专科</option> </select><br><br>
				<span id="aimageh0">
				上传校徽	&nbsp;	<input type='file' name='file' id='afile'/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>
				</span>
				
				</div>
				 <div style="float:left; padding-left: 20px;">
				是否有效	&nbsp;<input type="checkbox" name="isdelete" id="aisdelete" /><br><br>
				是211	&nbsp;<input type="checkbox" name="isniubi" id="aisniubi" /><br><br>
				是985	&nbsp;<input type="checkbox" name="ishenniubi" id="aishenniubi" /><br><br>
				 </div>
				 </div>
		...
		<div style="display: none;position:absolute ; z-index:999; top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="hid" >
		   <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="fclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form1" method="post" enctype="multipart/form-data" action="${contextPath}/sys/cooperationcolleges/fileUpload">			
				<input type="hidden" name="id" id="fid"/><br><br>
				<input type="hidden" id="editContent" name="addContent"/>
				<div style="float:left">
				<div style="float:left;"> 	
				合作院校名称	&nbsp;<input type="text" name="name" id="fname" maxlength="60"/><br><br>
				校训	&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="brief" id="fbrief" maxlength="255"/><br><br>
				类型	&nbsp;<select id="ftypeId" name="type"><option value="1">综合性</option><option value="2">理工</option><option value="3">体育</option> </select><br><br>
				性质	&nbsp;<select id="fxingzhi" name="xingzhi"><option value="1">本科</option><option value="2">专科</option> </select><br><br>
				<input type="hidden" name="image" id="image">
				<span  id="fimage"> 
				</span> 
				</div>
				<div style="float:left; padding-left: 100px;"> 	
				是否有效	&nbsp;<input type="checkbox" name="isdelete" id="fisdelete" /><br><br>
				是211	&nbsp;<input type="checkbox" name="isniubi" id="fisniubi" /><br><br>
				是985	&nbsp;<input type="checkbox" name="ishenniubi" id="fishenniubi" /><br><br>
				</div>
				</div>
				<div style="clear:both;"></div>
				<div>
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/cooperationcolleges/getCooperationCollegesList",
        			datatype : "json",
        			height : 650,
        			colNames : ['', 'ID', '合作院校名称', '校训','校徽','校徽路径','合作院校详情','类型','类型','性质','性质','211','211','985','985', '是否有效','是否有效', '创建人','创建时间','更新时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 60,
        			...
        			editurl : "${contextPath}/sys/cooperationcolleges/operateCooperationColleges"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		function typeChange(cellvalue, options, cell) {
        			console.log(cell)
        			if(cell.type==1)cellvalue="综合性";
        			else if(cell.type==2)cellvalue="理工";
        			else if(cell.type==3)cellvalue="体育";
        			else cellvalue ="";
        			return cellvalue;
        		}
        		
        		function xingzhiChange(cellvalue, options, cell) {
        			console.log(cell)
        			if(cell.xingzhi==1)cellvalue="本科";
        			else if(cell.xingzhi==2)cellvalue="专科";
        			else cellvalue ="";
        			return cellvalue;
        		}
        ...
        //=====================================================
			...
			$('[data-rel=popover]').popover({html:true});
				...
				$("#editaaa").click(function(){
					...
					//name 校训brief 合作院校介绍content 成本价costPrice 金额amount 类型categoryName 
        			//校徽image 型号xinghao 规格guige 材质caizhi 品牌pinpai 产地chandi 单位danwei 点击浏览次数clickNum 销量sales 热销rexiaoName
					...
					var isdelete=rowData.isdelete;
					var isniubi=rowData.isniubi;
					var ishenniubi=rowData.ishenniubi;
					console.log(rowData);
					var type=rowData.type;
					console.log(rowData);
					$("#ftypeId").val(type); 
					
					var xingzhi=rowData.xingzhi;
					$("#fxingzhi").val(xingzhi); 
					
					var image=rowData.logo;
					...
					if(""!=image){
						$("#image").val(image);
						$("#fimage").html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击校徽可修改校徽<br>校徽<img id="imagel" width="200px" height="100px" src="${contextPath}'+image + '"/><br/>' ); 
					}else{
						$("#fimage").html("上传校徽	&nbsp;	<input type='file' name='file' id='ffile'/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>" );
					}
					if(isdelete==1){
						$("#fisdelete").attr("checked","checked");
					}
					if(isniubi==1){
						$("#fisniubi").attr("checked","checked");
					}
					if(ishenniubi==1){
						$("#fishenniubi").attr("checked","checked");
					}
				...
				$("#addaaa").click(function(){
					...
					$("#achandi").val("");
					$("#adanwei").val("");   
					//$("#aimage").html("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击校徽可修改校徽<br>校徽"+image); 
