        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/productType/getProductType",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '类型编码', '类型名称', '排序', '上级类型编码'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        			...
        			editurl : "${contextPath}/sys/productType/operateProductType"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/productType/getProductType?oper=excel' method='post'>";
