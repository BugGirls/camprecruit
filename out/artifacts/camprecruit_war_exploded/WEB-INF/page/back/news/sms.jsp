        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/sms/getsms",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '接收手机号', '内容', '创建时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        				...
        				edittype : "select",
        				editoptions : {
        					dataUrl : "${contextPath}/sys/sms/getPhone"
        				}, 
        			}, {
        				name : 'content',
        				index : 'content',
        			...
        			editurl : "${contextPath}/sys/sms/operatesms"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/sms/operatesms?oper=excel' method='post'>";
