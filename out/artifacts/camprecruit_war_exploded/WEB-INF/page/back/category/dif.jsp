        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/Tzzdic/getCategory?type=2&parentId=0&level=0",
        			datatype : "json",
        			height : 450,
        		...
        		//scroll : 1, // set the scroll property to 1 to enable paging with scrollbar - virtual loading of records
        			...
        			editurl : "${contextPath}/sys/Tzzdic/operateDict?type=2&parentId=0&level=0"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/Tzzdic/operateDict?type=2&parentId=0&level=0&oper=excel' method='post'>";
