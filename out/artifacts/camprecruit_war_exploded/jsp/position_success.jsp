...
<title>职位发布成功-招聘服务-营才网-最专业的营地服务平台</title>
    ...
    <div id="container">
			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						<div class="ccc_tr">
							今日已发布 <span>1</span> 个职位 还可发布 <span>4</span> 个职位
						</div>
						<div class="c_notice"> 
		                	<h4 style=" background: #f1f1f1; padding: 15px; line-height: 75px;height: 75px;">
		                		<img width="80px" src="style/css/img/publish_tip.png" style=" margin: auto 20px;float: left;"/>
		                		<span style="float: left;">职位发布成功！</span>
		                	</h4>
		                    <a class="greylink" href="position_create.jsp">发布新职位</a>
		                    <a class="greylink" href="position_show.jsp?id=<%=positionid %>">查看该职位</a>
		                    <a class="greylink" href="company_center.jsp"> 进入我的公司主页</a>
		                </div>
					</dd>
				</dl>
			</div>
