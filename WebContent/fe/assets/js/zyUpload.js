        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '							<img class="upload_image" src="../assets/images/add_img.png" style="width:expression(this.width > ' + imgWidth + ' ? ' + imgWidth + 'px : this.width)" />';
                    html += '						</div>';
                    html += '					</a>';
                    html += '				</div>';
                    html += '			</div>';
            ...
            this.funDisposePreviewHtml = function (file, e) {
                ...
                // 处理不同类型文件代表的图标
                var fileImgSrc = "../assets/images/fileType/";
            ...
            this.createCorePlug = function () {
                var params = {
                    ...
                    onSuccess: function (file, responseInfo) {
                        para.onSuccess(file, responseInfo);
                    ...
                    onFailure: function (file, responseInfo) {
                        para.onFailure(file, responseInfo);
                        $("#uploadProgress_" + file.index).hide();
                        $("#uploadSuccess_" + file.index).show();
