...
<input id="hideid" style="display: none;"/>
		<script type="text/javascript">
    		...
    		$("#ok").click(function(){
    				$.ajax({
 	 	      		   type:"post",
 	        		   url:" ${contextPath}/sys/reservationalliance/verification",
 	        		   dataType:"json", 
 	       		  	   data:{"id":$("#hideid").val()},
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/reservationalliance/getReservationList",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID','订单号', '姓名', '联系电话', '预约门店', '预约日期',  '订单状态','openid', '下单时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        				...
        				editoptions : {
        					dataUrl : "${contextPath}/sys/store/getStoreSelectList"
        				},
        				search : true,
        				stype:'select',
        				searchoptions:{
        				...
        				editable : true,
        				edittype : "select",
        				editoptions : {value : "1:审核通过;0:待审核;2:已核销"},
        				search : true,
        				stype:'select',
        				searchoptions:{
        					sopt:["eq"],
        					value : "1:审核通过;0:待审核;2:已核销"
        				},
        			...
        			editurl : "${contextPath}/sys/reservationalliance/operateReservation"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/reservationalliance/operateReservation?oper=excel' method='post'>";
