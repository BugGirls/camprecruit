...
<input id="hideid" style="display: none;"/>
		<script type="text/javascript">
    		...
    		$("#ok").click(function(){
    				$.ajax({
 	 	      		   type:"post",
 	        		   url:" ${contextPath}/sys/TzzReservation/verification",
 	        		   dataType:"json", 
 	       		  	   data:{"id":$("#hideid").val()},
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/TzzReservation/getReservationList",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID','订单号', '姓名', '联系电话', '预约门店', '预约日期', '预约时间', '订单状态','openid', '下单时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        				...
        				editable : true,
        				edittype : "select",
        				editoptions : {value : "1:10:00-12:00;2:13:00-18:00;3:18:00-22:00"},
        				search : false,
        			...
        			editurl : "${contextPath}/sys/TzzReservation/operateReservation"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
