...
<div class="row">
	<div class="col-xs-12">
		<div style="background: #eafafb;">
			商品种类总数：<span id="productTotalTypeNum">0</span>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			商品总数：<span id="productTotalNum">0</span>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			建议售价总额：<span id="adviceTotalAmount">0</span>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			进价总额：<span id="saleTotalAmount">0</span>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
...
window.onload=function(){
	alert(1);
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/warehouseProduct/getWarehouseProductList",
        			datatype : "json",
        			height : 650,
        			colNames : ['编码', '商品名称', '品牌', '分类', '类型', '建议零售价','售价','库存数量','库存位置','生产日期'],
        			colModel : [ {
        				name : 'productNo',
        				index : 'productNo',
        				label : '编码',
        			...
        			editurl : "${contextPath}/sys/warehouseProduct/operateWarehouseProduct"
        		});
		...
		$.ajax({
	        type:"post", 
	        url:"${contextPath}/sys/warehouseProduct/getProductWarehouseCount",
	        data:{},
	   		dataType:"json", 
	       	success:function(data){    
	       		$("#productTotalTypeNum").text(data.productTotalTypeNum);
	       		$("#productTotalNum").text(data.productTotalNum);
	       		$("#adviceTotalAmount").text(data.adviceTotalAmount);
	       		$("#saleTotalAmount").text(data.saleTotalAmount);
	       	} 
	    });  
			...
			$('[data-rel=popover]').popover({html:true});
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/warehouseProduct/operateWarehouseProduct?oper=excel' method='post'>";
