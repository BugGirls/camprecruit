...
window.onload=function(){
	alert(1);
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/productShelf/getProductShelfList",
        			datatype : "json",
        			height : 650,
        			colNames : ['编码', '商品名称', '品牌', '分类', '类型', '建议零售价','售价','货架数量','货架位置','生产日期'],
        			colModel : [ {
        				name : 'productNo',
        				index : 'productNo',
        				label : '编码',
        			...
        			editurl : "${contextPath}/sys/productShelf/operateProductShelf"
        		});
		...
		$.ajax({
	        type:"post", 
	        url:"${contextPath}/sys/productShelf/getProductShelfCount",
	        data:{},
	   		dataType:"json", 
			...
			$('[data-rel=popover]').popover({html:true});
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/productShelf/operateProductShelf?oper=excel' method='post'>";
