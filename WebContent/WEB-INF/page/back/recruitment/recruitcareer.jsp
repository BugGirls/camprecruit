...
<div class="row">
	<div class="col-xs-12">
	<a href="javascript:history.go(-1);">返回主题招聘</a>
 		...
 		<div style="display: none;position:absolute ;z-index:999;top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="aid" >
		  <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="aclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form2" method="post" enctype="multipart/form-data" action="${contextPath}/sys/company/fileupload">  
			<input type="hidden" id="addContent" name="addContent"/>
			<input type="hidden" name="rid" value="${rid }"/>
			<div style="float:left;"> 
		  		公司简称	&nbsp;<input type="text" name="shortname" id="ashortname" maxlength="32"/>(<span style="color:red;">*必填项</span>)<br><br>
				公司全称		&nbsp;<input type="text" name="fullname" id="afullname" maxlength="128"/><br><br>
				公司简介		&nbsp;<input type="text" name="desc" id="adesc" /><br><br>
		...
		<div style="display: none;position:absolute ; z-index:999; top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="hid" >
		   <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="fclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form1" method="post" enctype="multipart/form-data" action="${contextPath}/sys/company/fileupload">			
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/company/getCompanyList",
        			datatype : "json",
        			height : 650,
        			colNames : ['', 'ID', '公司简称', '公司全称', '公司介绍', 'logo','所在城市','地址','联系方式','行业领域','所处阶段','规模'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 60,
        			...
        			editurl : "${contextPath}/sys/company/operateCompany"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
