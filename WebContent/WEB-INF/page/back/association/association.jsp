 		...
 		<div style="display: none;position:absolute ;z-index:999;top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="aid" >
		  <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			...
			<div style="float:left;"> 
				<div style="float:left;"> 		
		  		协会名称	&nbsp;<input type="text" name="name" id="aname" maxlength="60"/><br><br>
				链接地址		&nbsp;<input type="text" name="href" id="ahref" maxlength="255"/><br><br>
				<span id="aimageh0">
				上传协会logo	&nbsp;	<input type='file' name='file' id='afile'/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>
				</span>
		   ...
		   <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="fclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form1" method="post" enctype="multipart/form-data" action="${contextPath}/sys/alliancebusiness/fileUpload">			
				...
				<div style="float:left">
				<div style="float:left;"> 	
				协会名称	&nbsp;<input type="text" name="name" id="fname" maxlength="60"/><br><br>
				链接地址	&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="href" id="fhref" maxlength="255"/><br><br>
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/alliancebusiness/getAssociationList",
        			datatype : "json",
        			height : 650,
        			colNames : ['', 'ID', '协会名称', '链接地址','图片','图片路径','是否有效','是否有效', '创建人','创建时间','更新时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 60,
        			...
        			editurl : "${contextPath}/sys/alliancebusiness/operateAssociation"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		function typeChange(cellvalue, options, cell) {
        			console.log(cell)
        			if(cell.type==1)cellvalue="营地";
        			else if(cell.type==2)cellvalue="学校";
        			else cellvalue ="";
        			return cellvalue;
        		}
        ...
        //=====================================================
			...
			$('[data-rel=popover]').popover({html:true});
				...
				$("#editaaa").click(function(){
					...
					//name 链接地址href 内容介绍content 成本价costPrice 金额amount 类型categoryName 
					...
					if(""!=image){
						...
						$("#fimage").html("上传协会logo	&nbsp;	<input type='file' name='file' id='ffile'/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>" );
					}
					if(isdelete==1){
