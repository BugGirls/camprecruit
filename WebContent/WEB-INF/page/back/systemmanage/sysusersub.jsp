...
<div class="row">
	...
	<div id="hidediv" style="z-index:99;width:300px;height:200px;padding:20px 20px; position:absolute;background-color:#fff; border:1px solid #dcd; display: none; top: 100px ;left:50% ; ">
		<p style="text-align: center; font-size: 20px;">重置密码 </p>
		输入新密码：<input type="password"  id="pwd" maxlength="26"/> <br><br>
		确定新密码：<input type="text" id="npwd" maxlength="26"/> <br><br>
		...
		<script type="text/javascript">
    		...
    		$("#ok").click(function(){
    			if($("#pwd").val()==""){
    				...
    				$.ajax({
 	 	      		   type:"post",
 	        		   url:" ${contextPath}/sys/sysuser/newpwd",
 	        		   dataType:"json", 
 	       		  	   data:{"pwd":$("#pwd").val() ,"id":$("#hideid").val()},
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/sysuser/getSysUserSub",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '姓名', '性别', '邮箱', '联系电话', '生日', '所属部门', '角色', '是否禁用','重置密码', '最后登录时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
...
>>>>>>> merge project
        				...
        				formatter: function (value, grid, rows, state) {
        					 return "&nbsp;&nbsp;&nbsp;&nbsp;<button id= \"" + value + "\" style=\"background-color:#eee;border:1px solid #777; color:#999\" onclick='newmima(" + value + ")'>重置</button>";} ,
        				sorttype : "int",
        				search : false
        			}, {
        				name : 'lastLoginTime',
...
<<<<<<< HEAD
        			...
        			del : <shiro:hasPermission name="ROLE_RESTRICTED_ADMIN:delete">true</shiro:hasPermission><shiro:lacksPermission name="ROLE_RESTRICTED_ADMIN:delete">false</shiro:lacksPermission>,
        			delicon : 'ace-icon fa fa-trash-o red',
        			search : <shiro:hasPermission name="ROLE_RESTRICTED_ADMIN:search">true</shiro:hasPermission><shiro:lacksPermission name="ROLE_RESTRICTED_ADMIN:search">false</shiro:lacksPermission>,
