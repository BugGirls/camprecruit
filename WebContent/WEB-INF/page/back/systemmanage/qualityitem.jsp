 		...
 		<div style="display: none;position:absolute ;z-index:999;top:0;left:0;background-color: #fff;border: 1px solid #aaa;width: 600px;"" id="aid" >
		  <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="aclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form2" method="post" enctype="multipart/form-data"  action="${contextPath}/sys/qualityitem/saveOrUpdateQualityItem">  
			<input type="hidden" id="addContent" name="addContent"/>
			<div style="float:left;"> 
		  		素质项名称	&nbsp;<input type="text" name="itemname" id="aitemname" /><br><br>
		  		素质项描述	&nbsp;<textarea rows="10" cols="64" name="itemdesc" id="aitemdesc" ></textarea><br><br>
				是否可用	&nbsp;<input type="checkbox" name="status" id="astatus" role="checkbox" class="FormElement ace ace-switch ace-switch-5"/><span class="lbl"></span>
		...
		<div style="display: none;position:absolute ; z-index:999; top:0;left:0;background-color: #fff;border: 1px solid #aaa;" id="hid" >
		   <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="fclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form1" method="post"  enctype="multipart/form-data"  action="${contextPath}/sys/qualityitem/saveOrUpdateQualityItem">			
				<input type="hidden" name="id" id="fid"/><br><br>
				<div style="float:left">
					素质项名称	&nbsp;<input type="text" name="itemname" id="fitemname" /><br><br>
			  		素质项描述	&nbsp;<textarea rows="10" cols="64" name="itemdesc" id="fitemdesc" ></textarea><br><br>
					是否可用	&nbsp;<input type="checkbox" name="status" id="fstatus" role="checkbox" class="FormElement ace ace-switch ace-switch-5"/><span class="lbl"></span>
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/qualityitem/getQualityItemList",
        			datatype : "json",
        			height : 650,
        			colNames : ['','ID', '素质项名称','素质项描述', '是否可用'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 60,
        			...
        			editurl : "${contextPath}/sys/qualityitem/operateQualityItem"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        ...
        //=====================================================
			...
			$('[data-rel=popover]').popover({html:true});
				...
				$("#editaaa").click(function(){
					...
					$("#fid").val(id);
					$("#fitemname").val(itemname);
					$("#fitemdesc").val(itemdesc);
					if(status=="是"){
