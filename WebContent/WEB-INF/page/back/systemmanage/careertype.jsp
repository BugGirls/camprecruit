...
// 		};
		...
		function onRemove(e, treeId, treeNode) {
			var isparent = treeNode.isParent;
			$.ajax({
				url : "${contextPath}/sys/careertype/deleteNodeOfTree",
				type : 'POST',
		...
		function onRename(e, treeId, treeNode, isCancel) {
			$.ajax({
				url : "${contextPath}/sys/careertype/renameNodeOfTree",
				type : 'POST',
		...
		function addHoverDom(treeId, treeNode) {
			if(treeNode.id<10000){
				...
				if (btn) btn.bind("click", function(){
					...
					$.ajax({
						url : "${contextPath}/sys/careertype/addChildNodeOfTree",
						type : 'POST',
		...
		function add(e) {
			$.ajax({
				url : "${contextPath}/sys/careertype/getMaxRootId",
				type : 'POST',
				dataType : 'json',
				success : function(data) {
		...
		// 			} else {
						...
						$.ajax({
							url : "${contextPath}/sys/careertype/addNodeOfTree",
							type : 'POST',
...
// 		};
		...
		$(document).ready(function(){
			$.ajax({
				url : "${contextPath}/sys/careertype/getcareertypetree",
				type : 'POST',
				dataType : 'json',
				complete : function(response) {
			...
			$('#submitButton').on('click', function() {
				...
				$.ajax({
					url : "${contextPath}/sys/careertype/saveCareerTypeUrl",
					data : {
...
// 			$.ajax({
// 				url : "${contextPath}/sys/careertype/savetree",
// 				data : {
