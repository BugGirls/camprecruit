        ...
        $(".page-content-area").ace_ajax("loadScripts", scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/question/getQuestion",
        			datatype : "json",
        			height : 450,
        			colNames : ["","查看回答","ID", "标题", "发布者", "发布时间", "正文", "正文","类别","是否精华","置顶","解答状态","浏览次数"],
        			colModel : [ {//'', 'ID', '等级名称','最小消费金额', '享受折扣' 
        				...
        				formatter: function (value, grid, rows, state) 
        					{
        					 return "<a href=\"${contextPath}/sys/sysuser/home#page/answer?flag=" + value + "\" style=\"color:#89a\">点击查看</a>" ;} ,
        				sorttype : "int",
        				search : false
        			}, {
        				name : "id",
        			...
        			editurl : "${contextPath}/sys/question/operateQuestion"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid("navButtonAdd", pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/question/operateQuestion?oper=excel' method='post'>";
