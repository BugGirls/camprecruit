        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/comment/getPromotionComments",
        			datatype : "json",
        			height : 650,
        			colNames : ['','活动id','活动名称','订单号','评论人','评论时间','评论内容','评分'],
        			colModel : [{
        				name : '',
        				index : '',
        				width : 60,
...
//         				width : 160,
        				...
        				name : 'salesPromotion.name',
        				index : 'salesPromotion.name',
        				label : '活动名称',
//         				width : 300,
        				search : false
        			}, {
...
//         				width : 200 ,
        			...
        			editurl : "${contextPath}/sys/comment/operatePromotionComment",
        			//caption : "用户管理列表",
        			autowidth : true
        			/**
        			grouping : true, 
