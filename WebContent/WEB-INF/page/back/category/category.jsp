        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/Tzzdic/getCategory?type=1",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '类名称', '类标题', '父节点ID', '等级', '创建时间'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        				...
        				searchoptions : {sopt : ['eq']},
        				edittype : "select",
        				editoptions : {value : "1:一级分类;2:二级分类;3:三级分类"},
        			}, {
        				name : 'createTime',
        				index : 'createTime',
        				label : '创建时间',
        		...
        		//scroll : 1, // set the scroll property to 1 to enable paging with scrollbar - virtual loading of records
        			...
        			editurl : "${contextPath}/sys/Tzzdic/operateDict?type=1"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/Tzzdic/operateDict?type=1&oper=excel' method='post'>";
