...
<div class="panel panel-default">
  ...
  <div class="panel-heading">推荐人好处费统计</div>
...
<script type="text/javascript">
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		$.ajax({
        			type : "post",
        			url : " ${contextPath}/sys/allianceincome/getReferrerIncomeStatistics",
        			dataType:"json", 
        			success : function(data) {
        				...
        				//myBarChart.on(ecConfig.EVENT.CLICK, function(param){  
        	            	//var selected = param.userid;
        	            //	alert("userid:");
        	            	//window.location.href="/vreport/charts/barincome.jsp?year="+selected;
        	           // });
        			}
        		});
