...
// 	    	 $("#hidediv").show(); 
				$.ajax({
			        type:"post", 
			        url:"${contextPath}/sys/alliancepromotionurl/createPromotionStaffUrl",
			        data:{"id":id},
			   		dataType:"json", 
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/alliancepromotionurl/getAlliancePromotionUrlList?asid=${asid}",
        			datatype : "json",
        			height : 650,
        			colNames : ['活动id','活动名称','活动价格','活动有效期至','状态','员工id','员工姓名','提成比例','固定提成','活动链接','二维码','操作'],
        			colModel : [ {
        				name : 'promotionid',
        				index : 'promotionid',
        				label : '活动id',
			...
			$('[data-rel=popover]').popover({html:true});
				...
				function qrcodeUrl(cellvalue, options, cell) {
					if(cell.url!=null &&cell.url!=""){
        				cellvalue = "<a target='_blank' href='${contextPath}/jsp/qrcode/qrcode.jsp?url="+cell.url+"' >生成二维码</a>";
					}else{
						cellvalue = "";
					}
        			return cellvalue;
