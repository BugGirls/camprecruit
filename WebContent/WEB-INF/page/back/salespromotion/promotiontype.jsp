...
<div class="row">
	<div class="col-xs-12">
		...
		<!-- PAGE CONTENT ENDS > -->
		 ...
		 <div style="display: none;position:absolute ;top:20%;left:30%;background-color: #fff;border: 1px solid #aaa;" id="aid" >
		  ...
		  <div style="padding: 10px;">
		  	<form id="form2" method="post" enctype="multipart/form-data" action="${contextPath}/sys/promotiontype/fileUpload"> 
		  		<input type="hidden" name="style" value="0"/>
		  		类别名称	&nbsp;<input type="text" name="title" id="atitle" maxlength="255"/><br><br>
		...
		<div style="display: none;position:absolute ;top:20%;left:30%;background-color: #fff;border: 1px solid #aaa;" id="hid" >
		  ...
		  <div style="padding: 10px;">
		  	<form id="form1" method="post" enctype="multipart/form-data" action="${contextPath}/sys/promotiontype/fileUpload">			
				<input type="hidden" name="id" id="fid"/><br><br>
				类别名称	&nbsp;<input type="text" name="title" id="ftitle"/><br><br>
	...
	$('.page-content-area').ace_ajax('loadScripts',scripts,function() {
					...
					jQuery(function($) { 
							...
							jQuery(grid_selector).jqGrid({
												subGrid : false,
												url : "${contextPath}/sys/promotiontype/getTzzPromotionType",
												datatype : "json",
												height : 650,
												colNames : [ '', 'ID','图标', '类别名称', '排序', '是否显示', '创建时间' ],
												colModel : [
												{
													name : '',
													index : '',
												...
												editurl : "${contextPath}/sys/promotiontype/operateTzzPromotionType"
											//caption : "用户管理列表",
											//autowidth : true,
											/**
											grouping : true, 
