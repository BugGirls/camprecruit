 		...
 		<div style="display: none;position:absolute ;z-index:999;top:0;left:0;background-color: #fff;border: 1px solid #aaa;width: 600px;"" id="aid" >
		  <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			...
			<div style="float:left;"> 
		  		套餐价格名称	&nbsp;<input type="text" name="name" id="aname" maxlength="128"/><br><br>
				...
				套餐价格类型（是否统一价）	&nbsp;<input type="checkbox" name="pricetype" id="apricetype" /><br><br>
		   ...
		   <div style="border:1px solid #aaa ; background-color:#eee; color:#23b820;font-size:20px ;padding:5px ;text-align:center;">
			 ...
			 <input type="button"  style="float:left;"name="fclose"class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn btn-sm" value="取消">
		  	...
		  	<form id="form1" method="post" enctype="multipart/form-data" action="${contextPath}/sys/comboPrice/saveOrUpdateComboPrice">			
				...
				<div style="float:left">
				套餐价格名称	&nbsp;<input type="text" name="name" id="fname" maxlength="128"/><br><br>
				套餐单位		&nbsp;<input type="text" name="unit" id="funit" maxlength="32"/><br><br>
				价		格	&nbsp;&nbsp;&nbsp;<input type="text" name="price" id="fprice" maxlength="10"/><br><br>
				...
				套餐价格类型（是否统一价）	&nbsp;<input type="checkbox" name="pricetype" id="fpricetype" /><br><br>
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/comboPrice/getAllianceComboPriceList",
        			datatype : "json",
        			height : 650,
        			colNames : ['','按日期设置的价格', 'ID', '套餐价格名称', '单位', '价格','开始日期','结束日期','是否可用','大人数量','儿童数量','是否统一价','每日限额','所属套餐','指定日期价格'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 60,
			...
			$('[data-rel=popover]').popover({html:true});
        		...
        		$("#modal-table").on('shown.bs.modal', function() {
        			var remoteDateSource = function(options, callback) {
            			...
            			if (parent_id !== null) {
            				$.ajax({
            					url : "${contextPath}/sys/comboPrice/getAllianceComboTreeList?rand=" + Math.random(1000),
            					type : 'POST',
