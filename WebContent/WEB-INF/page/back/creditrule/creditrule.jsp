        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/CreditRule/getCreditRuleList",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '名称', '积分数', '可用次数','类型'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        			...
        			editurl : "${contextPath}/sys/CreditRule/operateCreditRule"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		function typeChange(cellvalue, options, cell) {
        			if(cell.type==1)cellvalue="增加";
        			else if(cell.type==0)cellvalue="减扣";
        			else cellvalue ="";
        			return cellvalue;
        		}
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/CreditRule/operateCreditRule?oper=excel' method='post'>";
