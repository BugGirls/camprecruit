...
<title>发布新职位-招聘服务-营才网-最专业的营地服务平台</title>
    ...
    <div id="container">
			...
			<div class="sidebar" >
				...
				<dl class="company_center_aside">
					<dt>我发布的职位</dt>
					<dd>
						<a href="position_list.jsp">有效职位</a>
					</dd>
					<dd>
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<td width="85">职位类别</td>
										<td><input type="hidden" id="type" value=""
											name="type"> <input type="button"
											value="请选择职位类别" id="select_category" name="type_value"
								...
								<tbody>
									<tr>
										...
										<td>
											<ul class="profile_radio clearfix reset">
												<li>全职<em></em> <input type="radio" name="nature"
													value="1">
												</li>
												<li>兼职<em></em> <input type="radio" name="nature"
													value="2">
												</li>
												<li>实习<em></em> <input type="radio" name="nature"
													value="3">
												</li>
											</ul>
										</td>
											...
											<div class="salary_range">
												<div>
													<input type="text" placeholder="最低月薪" value=""
														id="salaryfrom" name="salaryfrom"> <span>k</span>
												</div>
												<div>
													<input type="text" placeholder="最高月薪" value=""
														id="salaryto" name="salaryto"> <span>k</span>
												</div>
									...
									<tr>
										...
										<td><input type="text" placeholder="请输入工作城市，如：北京"
											value="上海" name="workcity" id="workcity"></td>
									</tr>
								</tbody>
							</table>
								...
								<tbody>
									<tr>
										...
										<td><input type="hidden" id="experience" value=""
											name="experience"> <input type="button" value="请选择工作经验"
									...
									<tr>
										...
										<td>学历要求</td>
										<!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
										<td><input type="hidden" id="edubackground" value=""
											name="edubackground"> <input type="button"
											value="请选择学历要求" id="select_edubackground"
											class="selectr selectr_380">
											<div class="boxUpDown boxUpDown_380 dn" id="box_edubackground"
												style="display: none;">
												<ul>
													<li value="0">不限</li>
													<li value="1">大专</li>
								...
								<tbody>
									...
									<tr>
										...
										<td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
											...
											<input type="hidden" name="positionDetail" id="positionDetail"
												/>
												
												<script id="fcontent"  type="text/plain"></script><br><br>
										</td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										...
										<td><input type="text" placeholder="请输入详细的工作地址" value=""
											name="workplace" class="input_520" id="workplace">
...
$(function(){
	$('#mapPreview').bind('click',function(){
		...
		var address = $('#workplace').val();
		var city = $('#workcity').val();
		   ...
		   success:function(data){ 
			    if(data.careertypes!=null && data.careertypes.length>0){
			    	...
			    	$.each( data.careertypes, function(i, n){
						...
						elements += '<dl><dt var="'+value.id+'">'+value.name+'</dt>';
						elements += '<dd ><ul class="reset job_main">';
				    	if(subtypes!=null && subtypes.length>0){
				    		$.each(subtypes, function(j, vals){
						    	elements += '<li var="'+vals.id+'"><span>'+vals.name+'</span></li>';
				    		});
				    	}
			            elements += '</ul></dd></dl>';
...
<script type="text/javascript"src="<%=requestPath %>/static/assets/js/jqGrid/i18n/grid.locale-cn.js"></script>
<script type="text/javascript"src="<%=requestPath %>/static/edit/ueditorconfig3.js"></script>
<script type="text/javascript"src="<%=requestPath %>/static/edit/ueditor.all.js"></script>
