...
function file_check(obj, action_url, id) {
	...
	0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? (errorTips("只支持word、pdf、ppt、txt、wps格式文件，请重新上传"), $("#loadingImg").css("visibility", "hidden")) : $.ajaxFileUpload({
		type: "POST",
		url: action_url,
		secureuri: !1,
		fileElementId: id,
		...
		success: function(jsonStr) {
			...
			json.success ? (html = '<a href="' + ctx + '/nearBy/downloadResume" class="resume_download" title="下载' + json.content.nearbyName + '">' + json.content.nearbyName + "</a>" + '<a  class="fr del" href="javascript:;">删除</a><br /><span class="c9">上传时间：' + json.content.time + "</span>", $("#myResume .resumeUploadDiv").html(html), $("#myResume h2 a").html("重新上传"), $.colorbox({
				inline: !0,
...
function(a, b) {
	...
	i.fn = a.extend(i.prototype, {
		parse: function(e, f, g, h) {
			...
			this; (e.jquery || e.nodeType) && (e = a(e).css(f), f = b);
			var k = this,
			l = a.type(e),
			m = this._rgba = [];
			return f !== b && (e = [e, f, g, h], l = "array"),
			"string" === l ? this.parse(d(e) || n._default) : "array" === l ? (o(j.rgba.props,
			function(a, b) {
				m[b.idx] = c(e[b.idx], b)
			}), this) : "object" === l ? (e instanceof i ? o(j,
			function(a, b) {
	...
	i.hook = function(b) {
		...
		function(b, c) {
			...
			a.fx.step[c] = function(b) {
				b.colorInit || (b.start = i(b.elem, c), b.end = i(b.end), b.colorInit = !0),
...
$(function() {
		...
		$(".projectForm").each(function() {
			$(this).validate({
				...
				submitHandler: function(a) {
					...
					$.ajax({
						url: ctx + "/top/resume/saveProjectExperience",
						type: "POST",
						data: {
							projectName: b,
							positionName: c,
						...
						b.success ? (c = b.projectExperience, e = "", 3 == b.code ? "" != c ? (e += '<li data-id="' + c.id + '">', e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.project + '" data-posName="' + c.duty + '" data-startY="' + c.fromyear + '" data-startM="' + c.frommonth + '" data-endY="' + c.toyear + '"' + 'data-endM="' + c.tomonth + '">' + c.project+'<br>'+c.duty + '<span class="c9">（' + c.fromyear +"."+c.frommonth+ "-" + (c.toyear=="至今"?"至今":c.toyear +"."+c.tomonth) + "）</span></div>", "" != c.projectdesc && (e += '<div class="dl1">' + c.projectdesc + "</div>"), e += "</div></li>", "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) && $(a).remove(), d.obj.children(".c_add").removeClass("dn"), d.obj.children(".projectShow").children(".plist").prepend(e), d.obj.children(".projectShow").removeClass("dn"), d.obj.children(".projectEdit").addClass("dn")) : "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) ? ($(a).remove(), d.obj.children(".c_add").removeClass("dn")) : (d.obj.children(".projectEdit").addClass("dn"), d.obj.children(".projectAdd").removeClass("dn")) : 4 == b.code ? (e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.project + '" data-posName="' + c.duty + '" data-startY="' + c.fromyear + '" data-startM="' + c.frommonth + '" data-endY="' + c.toyear + '"' + 'data-endM="' + c.tomonth + '">' + c.projectdesc + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>", "" != c.projectdesc && (e += '<div class="dl1">' + c.projectdesc + "</div>"), e += "</div>", $(a).parent("li").html(e)) : 2 == b.code && ($(a).parent("li").remove(), 0 == d.obj.children(".projectShow").children(".plist").children("li").length && d.AddCancel), d.obj.find(".plist li:last-child").addClass("noborder"), $("#lastChangedTime span").text(b.modifytime), scoreChange(b.score), k(d.obj)) : alert(b.msg),
		...
		$(".workForm").each(function() {
			$(this).validate({
				...
				submitHandler: function(a) {
					...
					$(a).find(":submit").val("保存中...").attr("disabled", !0),
					$.ajax({
						url: ctx + "/top/resume/saveProduction",
						type: "POST",
						data: {
							url: b,
							workName: c,
						...
						var c, d, e;
						$("#resubmitToken").val(b.resubmitToken),
						b.success ? (c = "", d = "", e = b.production, 3 == b.code ? "" != e ? (c += '<li data-id="' + e.id + '"><div class="workList c7">' + '<i class="sm_del dn"></i>' + '<i class="sm_edit dn"></i>', e.href && (d = "http://" == e.href.substring(0, 7) || "https://" == e.href.substring(0, 8) ? e.href: "http://" + e.href, c += '<div class="f16">网址：<a href="' + d + '" target="_blank">' + e.href + "</a></div>"), c += "<p>" + e.introduction + "</p>" + "</div></li>", placeholderFn(), "" != $.trim(h.obj.children(".workShow").children(".slist").html()) && $(a).remove(), h.obj.children(".workShow").children(".slist").prepend(c), h.obj.children(".workShow").removeClass("dn"), h.obj.children(".workEdit").addClass("dn"), h.obj.children(".c_add").removeClass("dn")) : "" != $.trim(h.obj.children(".workShow").children(".slist").html()) ? ($(a).remove(), h.obj.children(".c_add").removeClass("dn")) : (h.obj.children(".workEdit").addClass("dn"), h.obj.children(".workAdd").removeClass("dn")) : 4 == b.code ? (c += '<div class="workList c7"><i class="sm_del dn"></i><i class="sm_edit dn"></i>', e.href && (d = "http://" == e.href.substring(0, 7) || "https://" == e.href.substring(0, 8) ? e.href: "http://" + e.href, c += '<div class="f16">网址：<a href="' + d + '" target="_blank">' + e.href + "</a></div>"), c += "<p>" + e.introduction + "</p>" + "</div>", placeholderFn(), $(a).parent("li").html(c)) : 2 == b.code && ($(a).parent("li").remove(), "" == $.trim(h.obj.children(".workShow").children(".slist").html()) && h.AddCancel), h.obj.find(".slist li:last-child").addClass("noborder"), $("#lastChangedTime span").text(b.modifytime),  scoreChange(b.score), k(h.obj)) : alert(b.msg),
						$(a).find(":submit").val("保 存").attr("disabled", !1)
					})
				}
			})
	...
	$("#resumeNameForm").validate({
		...
		submitHandler: function(a) {
			...
			$.ajax({
				url: ctx + "/top/resume/renameResume",
				type: "POST",
				dataType: "json",
				data: {
					resumeName: b,
					...
					var c = b.resumeName;
					c = b.resumeName.length > 18 ? b.resumeName.substring(0, 15) + "...": b.resumeName,
					$("#resumename").text(b.resumeName	);
					$("#resumename").attr("title", b.resumeName).text(c).parent().removeClass("dn"),
					$("#resumeNameForm").addClass("dn"),
					$("#lastChangedTime span").text(b.modifytime),
					k($("#resume_name"))
	...
	$("#profileForm").validate({
		...
		submitHandler: function(a) {
			...
			age = $('input[name="age"]', a).val(),
			residence = $('input[name="residence"]', a).val(),
			i = $("#pageType").val(),
			j = $("#resumeId").val(),
			l = $("#resubmitToken").val();
			$(a).find(":submit").val("保存中...").attr("disabled", !0);
			if(frompage==1){
				$.ajax({
					url: ctx + "/top/individualuser/completeUserInfo",
					type: "POST",
					data: {
						userid: userid,
						name: b,
					...
					dataType: "json"
					 ...
					 var resume = b.resume;
		    		  ...
		    		  if(resume.image!=null&&resume.image!=""){
			    		  $('#headimage').attr("src",ctx + resume.image);
		    		  }
...
//					b.success ? "/resume/myresume.html" == b.content.url ? window.location.href = ctx + b.content.url: (c = b.content.resume, d = c.workYear, "应届毕业生" != d ? (d += "工作经验", $("#workExperience h2 span").text("（投递简历时必填）")) : $("#workExperience h2 span").text(""), e = c.name, "" != c.sex && (e += " | " + c.sex), "" != c.highestEducation && (e += " | " + c.highestEducation), e += " | " + d + "<br />" + c.phone + " | " + c.email + "<br />" + c.status, $(".collapsible_menu dt").html(c.name + "<i></i>"), $("#basicInfo .basicShow span").html(e).parent().removeClass("dn"), $("#basicInfo .basicEdit").addClass("dn"), $("#basicInfo .c_edit").removeClass("dn"), $("#nameVal").val(c.name), $("#genderVal").val(c.sex), $("#topDegreeVal").val(c.highestEducation), $("#workyearVal").val(c.workYear), $("#currentStateVal").val(c.status), $("#emailVal").val(c.email), $("#telVal").val(c.phone), $("#lastChangedTime span").text(b.content.refreshTime), b.content.isNew && changeAllIds(b.content.jsonIds), scoreChange(b.content.infoCompleteStatus.score), k($("#basicInfo"))) : alert(b.msg),
	...
	b = {
		...
		Edit: function() {
			"" == $("#expectCityVal").val() ? ($("#expectCity").val(""), $("#select_expectCity").val("期望城市，如：北京").css("color", "#999")) : ($("#expectCity").val($("#expectCityVal").val()), $("#select_expectCity").val($("#expectCityVal").val()).css("color", "#333")),
			"" != $("#typeVal").val() ? $('#expectJob .profile_radio li input[value="' + $("#typeVal").val() + '"]').attr("checked", !0).parent("li").addClass("current").siblings("li").removeClass("current") : $("#expectJob .profile_radio li input").attr("checked", !1).parent("li").removeClass("current"),
			$("#expectPosition").val($("#expectPositionVal").val()),
			"" == $("#expectSalaryVal").val() ? ($("#expectSalary").val(""), $("#select_expectSalary").val("期望月薪").css("color", "#999")) : ($("#expectSalary").val($("#expectSalaryVal").val()), $("#select_expectSalary").val($("#expectSalaryVal").val()).css("color", "#333")),
			placeholderFn(),
			this.obj.find(".expectAdd").addClass("dn"),
			this.obj.find(".expectShow").addClass("dn"),
			this.obj.find(".c_edit").addClass("dn"),
		...
		Cancel: function() {
			$("#expectCityVal").val() || $("#typeVal").val() || $("#expectPositionVal").val() || $("#expectSalaryVal").val() ? this.obj.find(".expectEdit").addClass("dn").siblings(".expectShow").removeClass("dn").siblings(".c_edit").removeClass("dn").siblings(".expectAdd").addClass("dn") : this.obj.find(".expectEdit").addClass("dn").siblings(".expectShow").addClass("dn").siblings(".c_edit").addClass("dn").siblings(".expectAdd").removeClass("dn"),
			k(this.obj)
		}
	},
	...
	$("#expectForm").validate({
		...
		submitHandler: function(a) {
			...
			$(a).find(":submit").val("保存中...").attr("disabled", !0),
			$.ajax({
				url: ctx + "/top/resume/saveExpectationInfo",
				type: "POST",
				data: {
					city: c,
					positionType: d,
				...
				if ($("#resubmitToken").val(g.resubmitToken), g.success) {
					if (c || d || e || f) {
						console.log("content"+g.expectation);
						var h = g.expectation.career;
						...
						b.obj.find("#expectJobVal").val(g.expectation.career),
						b.obj.find("#expectCityVal").val(g.expectation.city),
						b.obj.find("#typeVal").val(g.expectation.nature),
						b.obj.find("#expectPositionVal").val(g.expectation.career),
						b.obj.find("#expectSalaryVal").val(g.expectation.salary),
						b.expectJobVal = g.expectation.career,
						b.expectCityVal = g.expectation.city,
						b.typeVal = g.expectation.nature,
						b.expectPositionVal = g.expectation.career,
						b.expectSalaryVal = g.expectation.salary,
						$("#lastChangedTime span").text(g.modifytime)
...
//						k(b.obj)
					} else b.obj.find(".expectShow").addClass("dn"),
					b.obj.find(".expectEdit").addClass("dn"),
...
//					g.content.isNew && changeAllIds(g.content.jsonIds)
	...
	$(".select_companyYearStart").bind("click",
	function(a) {
		a.stopPropagation(),
		openYear("companyYearStart")
	}),
	$(".box_companyYearStart").on("click", "ul li",
	function(a) {
		var b, c;
		a.stopPropagation(),
		b = $(this).text(),
	...
	$(".select_companyMonthStart").bind("click",
	function(a) {
		a.stopPropagation(),
		openYear("companyMonthStart")
	}),
	$(".box_companyMonthStart").on("click", "ul li",
	function(a) {
		var b, c;
		a.stopPropagation(),
		b = $(this).text(),
	...
	$(".select_companyYearEnd").bind("click",
	function(a) {
		a.stopPropagation(),
		openYear("companyYearEnd")
	}),
	$(".box_companyYearEnd").on("click", "ul li",
	function(a) {
		var b, c, d;
		a.stopPropagation(),
		b = $(this).text(),
		...
		"至今" == $.trim(b) ? (d.find(".companyMonthEnd").val("至今"), d.find(".select_companyMonthEnd").css("color", "#333").val("至今"), d.find(".select_companyMonthEnd").unbind("click")) : ("至今" == $.trim(c) && (d.find(".companyMonthEnd").val(""), d.find(".select_companyMonthEnd").css("color", "#999").val("结束时间")), d.find(".select_companyMonthEnd").bind("click",
		function(a) {
			a.stopPropagation(),
	...
	$(".select_companyMonthEnd").bind("click",
	function(a) {
		a.stopPropagation(),
		openYear("companyMonthEnd")
	}),
	$(".box_companyMonthEnd").on("click", "ul li",
	function(a) {
		var b, c;
		a.stopPropagation(),
		b = $(this).text(),
	...
	c = {
		...
		Del: function(a) {
			...
			$.ajax({
				url: ctx + "/top/resume/delWorkExperience",
				type: "POST",
				dataType: "json",
				data: {
					expid: b,
				...
				b.success ? (a.parent("li").remove(), "" == b.workExperiences || null == b.workExperiences ? (c.obj.children(".experienceShow").addClass("dn"), c.obj.children(".experienceEdit").addClass("dn"), c.obj.children(".experienceAdd").removeClass("dn"), c.obj.children(".c_add").addClass("dn")) : c.obj.children(".experienceShow").children(".experienceForm").hide(), $("#lastChangedTime span").text(b.modifytime)) : alert(b.msg)
			})
		},
		AddCancel: function() {
	...
	$(".experienceForm").each(function() {
		$(this).validate({
			...
			submitHandler: function(a) {
				...
				$(a).find(":submit").val("保存中...").attr("disabled", !0),
				$.ajax({
					url: ctx + "/top/resume/saveWorkExperience",
					type: "POST",
					data: {
						companyName: b,
						positionName: d,
					...
					if ($("#resubmitToken").val(b.resubmitToken), b.success) {
						for (d = b.workExperiences, e = "", f = 0; f < d.length; f++) e += 0 == f % 2 ? '<li data-id="' + d[f].id + '" class="clear">': '<li data-id="' + d[f].id + '">',
...
//						b.content.isNew && changeAllIds(b.content.jsonIds)
	...
	function(a) {
		...
		"至今" == $.trim(b) ? (d.find(".projectMonthEnd").val("至今"), d.find(".select_projectMonthEnd").css("color", "#333").val("至今"), $("#projectExperience").off("click", ".select_projectMonthEnd")) : ("至今" == $.trim(c) && (d.find(".projectMonthEnd").val(""), d.find(".select_projectMonthEnd").css("color", "#999").val("结束时间")), $("#projectExperience").on("click", ".select_projectMonthEnd",
		function(a) {
			a.stopPropagation(),
			$(".profile_select_normal").removeClass("select_focus"),
			$(".boxUpDown").hide(),
	...
	$("#projectExperience").on("click", ".box_projectMonthEnd li",
	function(a) {
		var b, c;
		a.stopPropagation(),
		b = $(this).text(),
	...
	d = {
		...
		Del: function(a) {
			...
			$.ajax({
				url: ctx + "/top/resume/delProjectExperience",
				type: "POST",
				dataType: "json",
				data: {
					id: b,
				...
				b.success ? (a.parents("li").remove(), $("ul.plist li:last-child").addClass("noborder"), ("" == b.projectExperiences || null == b.projectExperiences) && (d.obj.children(".projectShow").addClass("dn"), d.obj.children(".projectEdit").addClass("dn"), d.obj.children(".projectAdd").removeClass("dn"), d.obj.children(".c_add").addClass("dn")), $("#lastChangedTime span").text(b.modifytime),scoreChange(b.score)) : alert(b.msg)
			})
		},
		AddCancel: function() {
	...
	f = {
		...
		Del: function(a) {
			var b = a.parent("li").attr("data-id");
			$.ajax({
				url: ctx + "/top/resume/delEducation",
				type: "POST",
				dataType: "json",
				data: {
					id: b,
				...
				b.success ? (a.parent("li").remove(), "" == b.educationExperiences || null == b.educationExperiences ? (f.obj.children(".educationalShow").addClass("dn"), f.obj.children(".educationalEdit").addClass("dn"), f.obj.children(".educationalAdd").removeClass("dn"), f.obj.children(".c_add").addClass("dn")) : f.obj.children(".educationalShow").children(".educationalForm").hide(), $("#lastChangedTime span").text(b.modifytime),scoreChange(b.score), k(f.obj)) : alert(b.msg)
			})
		},
		AddCancel: function() {
	...
	$(".educationalForm").each(function() {
		$(this).validate({
			...
			submitHandler: function(a) {
				...
				$(a).find(":submit").val("保存中...").attr("disabled", !0),
				$.ajax({
					url: ctx + "/top/resume/saveEducation",
					type: "POST",
					data: {
						schoolName: b,
						education: c,
					...
					var c, d, e;
					if ($("#resubmitToken").val(b.resubmitToken), b.success) {
						for (c = b.educationExperiences, d = "", e = 0; e < c.length; e++) d += 0 == e % 2 ? '<li data-id="' + c[e].id + '" class="clear">': '<li data-id="' + c[e].id + '">',
...
//						b.content.isNew && changeAllIds(b.content.jsonIds)
	...
	$(".descriptionForm").validate({
		...
		submitHandler: function(a) {
			...
			$(a).find(":submit").val("保存中...").attr("disabled", !0),
			$.ajax({
				url: ctx + "/top/resume/saveSelfAssessment",
				type: "POST",
				data: {
					myRemark: b,
					id: curresumeid,
				...
				var c, d;
				$("#resubmitToken").val(b.resubmitToken),
				b.success ? (c = b.myRemark, d = "", c ? (d = c, g.text = c, g.obj.children(".c_edit").removeClass("dn"), g.obj.children(".descriptionShow").html(d).removeClass("dn"), g.obj.children(".descriptionEdit").addClass("dn"), $("#lastChangedTime span").text(b.modifytime), scoreChange(b.score), k(g.obj)) : (g.text = "", g.obj.children(".c_edit").addClass("dn"), g.obj.children(".descriptionShow").addClass("dn"), g.obj.children(".descriptionEdit").addClass("dn"), g.obj.children(".descriptionAdd").removeClass("dn"), $("#lastChangedTime span").text(b.modifytime),  scoreChange(b.score), k(g.obj))) : alert(b.msg),
				$(a).find(":submit").val("保 存").attr("disabled", !1)
			})
		}
	}),
	h = {
		...
		Del: function(a) {
			var b = a.parents("li").attr("data-id");
			$.ajax({
				url: ctx + "/top/resume/delProduction",
				type: "POST",
				data: {
					id: b,
					resumeid: curresumeid
				...
				b.success ? (a.parents("li").remove(), $("ul.slist li:last-child").addClass("noborder"), ("" == b.productions || null == b.productions) && (h.obj.children(".workShow").addClass("dn"), h.obj.children(".workEdit").addClass("dn"), h.obj.children(".workAdd").removeClass("dn"), h.obj.children(".c_add").addClass("dn")), $("#lastChangedTime span").text(b.modifytime),scoreChange(b.score)) : alert(b.msg)
			})
		},
		AddCancel: function() {
	...
	function() {
		var b = $(this).parents("#resumeSet"),
		c = b.children(".defaultResume").val(); - 1 == c ? (b.children(".noSet").show(), b.children(".set0").hide(), b.children(".set1").hide(), b.children("#resumeSetForm").addClass("dn")) : (b.children(".noSet").hide(), b.children(".set" + c).show(), b.children("#resumeSetForm").addClass("dn")),
		a = !0
	}),
	$("#resumeSetForm").validate({
		...
		submitHandler: function(b) {
			...
			$.ajax({
				...
				d.success ? (a = !0, $("#resumeSet .noSet").hide(), $("#resumeSet .set" + c).show(), $("#resumeSet .defaultResume").val(c), $("#resumeSetForm").addClass("dn")) : alert(d.msg),
	...
	$(".skillForm").each(function() {
		$(this).validate({
			...
			submitHandler: function(a) {
				var skillname = $('input[name="skillName"]', a).val(),
				skilldegree = $('input[name="skilldegree"]', a).val(),
				b = $('textarea[name="skillDescription"]', a).val(),
				c = $("#resumeId").val(),
				skillid = $(".skillId", a).val(),
				d = $("#resubmitToken").val();
				$(a).find(":submit").val("保存中...").attr("disabled", !0),
				$.ajax({
					url: ctx + "/top/resume/saveSkill",
					type: "POST",
					data: {
						skillName: skillname,
					...
					if ($("#resubmitToken").val(b.resubmitToken), b.success) {
						...
						s.obj.children(".c_add").removeClass("dn"),
						s.obj.children(".skillShow").children(".skillForm").hide(),
						s.obj.children(".skillShow").children(".slist").html(d).parent().removeClass("dn"),
						s.obj.children(".skillEdit").addClass("dn"),
						$("#lastChangedTime span").text(b.modifytime),
//						$("#resumeScore .which div").text(b.content.infoCompleteStatus.msg),
//						$("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage),
						scoreChange(b.score)
...
//						b.content.isNew && changeAllIds(b.content.jsonIds)
	...
	s = {
			obj: $("#skills"),
			resetForm: function() {
				this.obj.children(".skillEdit").find(".skillName").val(""),
				this.obj.children(".skillEdit").find(".skilldegree").val(""),
				this.obj.children(".skillEdit").find(".select_skilldegree").css("color", "#999").val("掌握程度"),
				this.obj.children(".skillEdit").find(".word_count").children("span").text(100)
			},
			Add: function() {
				
				this.resetForm(),
				placeholderFn(),
				this.obj.children(".skillAdd").addClass("dn"),
				this.obj.children(".skillShow").addClass("dn"),
				//s.obj.children(".skillShow").find("form").addClass("dn"),
				this.obj.children(".skillEdit").removeClass("dn"),
				j(this.obj)
			},
			AddMore: function() {
				this.resetForm(),
				this.obj.children(".skillShow").prepend(this.obj.children(".skillEdit").children("form").clone()),
				this.obj.children(".skillShow").find(".select_skilldegree").css("color", "#999").val("掌握程度"),
				this.obj.children(".skillEdit").addClass("dn"),
				placeholderFn(),
				j(this.obj)
			},
			Edit: function(a) {
				...
				e && (e = $.trim(e.replace(/<br>/gi, ""))),
				this.resetForm(),
				f = this.obj.children(".skillEdit").children("form").clone(),
				f.find(".skillNme").val(d),
				f.find(".skillDescription").val(e),
				f.find(".select_skilldegree").css("color", "#999").val(e),
				f.find(".word_count").children("span").text(100 - f.find(".skillDescription").val().length),
				f.find(".skillId").val(c),
				a.parents("li").prepend(f),
				placeholderFn(),
				a.parents("li").children(".slist").addClass("dn"),
				j(this.obj)
			},
			Del: function(a) {
				var b = a.parents("li").attr("data-id");
				$.ajax({
					url: ctx + "/top/resume/delSkill",
					type: "POST",
					data: {
						id: b,
						resumeid: curresumeid
					...
					b.success ? (a.parents("li").remove(), $("ul.slist li:last-child").addClass("noborder"), ("" == b.skills || null == b.skills) && (s.obj.children(".skillShow").addClass("dn"), s.obj.children(".skillEdit").addClass("dn"), s.obj.children(".skillAdd").removeClass("dn"), s.obj.children(".c_add").addClass("dn")), $("#lastChangedTime span").text(b.modifytime),scoreChange(b.score)) : alert(b.msg)
				})
			},
			AddCancel: function() {
				this.obj.find(".skillAdd").removeClass("dn"),
				this.obj.find(".skillShow").addClass("dn"),
				this.obj.find(".skillEdit").addClass("dn"),
				k(this.obj)
			},
			AddMoreCancel: function(a) {
				a.parents(".skillForm").siblings(".sList").removeClass("dn"),
				a.parents(".skillForm").remove(),
				0 == $("ul.slist li").length && $(".skillAdd").removeClass("dn"),
				k(this.obj)
			}
		},
		s.obj.find(".slist li:last-child").addClass("noborder"),
		s.obj.find(".skillAdd").bind("click",
		function() {
			s.Add()
		}),
		s.obj.find(".c_add").bind("click",
		function() {
			s.AddMore(),
			$(this).addClass("dn")
		}),
		s.obj.on("click", ".sm_edit",
		function() {
			s.Edit($(this))
		}),
		s.obj.on("click", ".sm_del",
		function() {
			confirm("确认要删除吗？") && s.Del($(this))
		}),
		s.obj.children(".skillShow").on({
			mouseenter: function() {
				$(this).children(".slist").find(".sm_del,.sm_edit").removeClass("dn")
			},
			mouseleave: function() {
		...
		s.obj.children(".skillEdit").find(".btn_profile_cancel").bind("click",
		function() {
			s.AddCancel()
		}),
		s.obj.children(".skillShow").on("click", ".btn_profile_cancel",
		function() {
			s.AddMoreCancel($(this)),
			s.obj.find(".c_add").removeClass("dn")
		}),
		$(".select_skilldegree").bind("click",
				function(a) {
					a.stopPropagation(),
					$(this).addClass("select_focus"),
					$(".box_skilldegree").show()
		}),
		$(".box_skilldegree").on("click", "ul li",
				function(a) {
					a.stopPropagation();
					var b = $(this).text();
					$(".select_skilldegree").val(b).css("color", "#333").removeClass("select_focus"),
					$(".skilldegree").val(b),
					$(".box_skilldegree").hide(),
					$(this).parents(".skillForm").validate().element($(".skilldegree"))
		}),
		s.obj.on("keyup", ".s_textarea",
		function() {
			var a = $(this);
			$.trim(a.val()).length > 100 ? a.val($.trim(a.val()).substring(0, 100)) : a.next(".word_count").children("span").text(100 - $.trim(a.val()).length)
		})
